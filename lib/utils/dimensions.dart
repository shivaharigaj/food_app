...
class Dimensions{
  ...
  static double height15 = screenHeight/61;
    ...
    static double height350 = screenHeight/2.61;
    static double height70 = screenHeight/13.07;
  ...
  static double width45 = screenHeight/20.33;
 static double width5 = screenHeight/183;
 static double width200 = screenHeight/4.575;


  static double font20 = screenHeight/45.75;
  static double font26 = screenHeight/35.19;
  ...
  static double iconSize16 = screenHeight/57.1875;


  // list view size
  static double ListViewImgSize = screenHeight/7.625;
  ...
  // food detaias
  static double FoodDetailImgSize = screenHeight/7.25;
